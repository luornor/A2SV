...
(1≤t≤36) — the number of test cases. The description of test cases follows.
...
The input is generated in such a way that there is always exactly one 
possible location of the bishop that is not on the edge of the board."""
